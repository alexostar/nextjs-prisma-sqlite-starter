INSERT INTO ecosystem ("id2", "title", "status", "content", "slug") VALUES ('1', 'Verndað og friðlýst land', 'danger', '**Gróðursetjið ekki**
...
[Meiri upplýsingar](/verndad) ', 'verndad'), ('2', 'Tegundaauðugt land og land með kolefnisríkum jarðvegi', 'danger', '**Gróðursetjið ekki**
...
[Kort - Tegundaauðugt land](/kort/tegundaaudugt)

[Kort - Kolefnisríkt land](/kort/kolefnisrikt)

[Meiri upplýsingar](/tegundaaudugt)
', 'tegundaaudugt'), ('3', 'Votlendi, bæði náttúrlegt og framræst', 'danger', '**Gróðursetjið ekki**
...
[Meiri upplýsingar](/votlendi)', 'votlendi'), ('4', 'Strandlendi', 'danger', '**Gróðursetjið ekki**
...
[Kort](/kort/strandlendi)

[Meiri upplýsingar](/strandlendi) ', 'strandlendi'), ('5', 'Birkiskógar', 'danger', '**Gróðursetjið ekki**
...
[Kort](/kort/birkiskogar)

[Meiri upplýsingar](/birkiskogar)
', 'birkiskogar'), ('6', 'Mólendi', 'danger', '**Gróðursetjið ekki**
...
[Meiri upplýsingar](/molendi)
', 'molendi'), ('7', 'Gamalgróið graslendi', 'warning', '**Leitið ráða**
...
[Meiri upplýsingar](/graslendi)', 'graslendi'), ('8', 'Önnur vistlendi og landgerðir', 'warning', 'Moslendi, hraunlendi, eyrar, skriður og klettar, moldir, melar og sandlendi, alaskalúpína

[Kort](/kort/onnur-vistlendi)

**Land mögulega opið til endurheimtar/skógræktar neðan 400 m hæðarmarka**

[Kort](/kort/endurheimt)

_Endurheimt birkiskóga_

**Leitið ráða**

Í stefnumótun stjórnvalda um endurheimt hnignaðra vistkerfa er lögð áhersla á birkiskóga. Ísland hefur auk þess skrifað undir Bonn-áskorunina þar sem gert er ráð fyrir að auka útbreiðslu birkis á næstu árum. Endurheimt birkiskóglendis kemur til greina í margs konar landi ...

_Skógrækt með framandi tegundum - iðnaðar og kolefnisskógrækt_

**Leitið ráða**

Skógrækt með framandi tegundum kemur sums staðar til greina. Vegna þeirra miklu breytinga sem slík skógrækt hefur á vistkerfi landsins, líffræðilega fjölbreytni, útsýni, á ásýnd lands o.fl. er afar mikilvægt að fara að með mikilli gát. Um slíka skógrækt gilda nú þegar nokkrar takmarkanir ...

[Meiri upplýsingar](/onnur-vistlendi)', 'onnur-vistlendi');