  ...
  return (
    <div className='mx-auto flex max-w-[1200px] flex-col items-center justify-center pt-4'>
      <div className='flex w-full flex-row justify-start'>
        <Link href='/' className='mb-4 text-left'>
      ...
      <h1 className='ml-8  text-xl font-bold lg:ml-0 mb-4'>
        Tegundaauðugt land neðan 400 m hæðarmarka
      </h1>
        ...
        <TransformWrapper>
          {({ zoomIn, zoomOut, resetTransform }) => (
            <>
              ...
              <TransformComponent>
                <Image
                  src='https://hlkyrtglhpmrhzudaqzu.supabase.co/storage/v1/object/public/vin2024/vist-tegundaaudugt.jpg'
                  alt='Vistgerdakort'
                  width={2100}
                  height={1400}
                  style={{
